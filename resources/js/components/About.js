      ...
      <div className="container mt-5">
        <div className="row justify-content-center text-center">
            <div className="col-md-12">
              <img src="https://thewebland.net/wp-content/uploads/2017/11/laravel-react.png" alt style={{width: '300px'}}/>
               <h1 style={{color: '#445365',marginTop: '20px'}}>GeoShops App</h1>
               <p style={{margin: '30px auto', width: '600px', fontSize: '18px'}}>
                Welcome, this project is a simple web coding challenge created as the second step for job application
